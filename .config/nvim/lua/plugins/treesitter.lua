...
return {
  ...
  -- Include Comment.nvim separately as it's not directly part of Treesitter core/textobjects
  { 'numToStr/Comment.nvim', opts = {}, lazy = false }, -- Load eagerly for commenting
}
